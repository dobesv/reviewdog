...
much welcome. Please leave comments in Pull Request ([#629](https://github.com/dobesv/reviewdog/pull/629)),
in issue [#628](https://github.com/dobesv/reviewdog/issues/628) or
file [an issue](https://github.com/dobesv/reviewdog/issues).

The document and the actual definition are currently under the
https://github.com/dobesv/reviewdog repository, but we may create a separate
...
[reviewdog](https://github.com/dobesv/reviewdog) resolves the above problem
