...
import (
	...
	"github.com/dobesv/reviewdog/cienv"
	"github.com/dobesv/reviewdog/commands"
	"github.com/dobesv/reviewdog/filter"
	"github.com/dobesv/reviewdog/parser"
	"github.com/dobesv/reviewdog/project"
	bbservice "github.com/dobesv/reviewdog/service/bitbucket"
	gerritservice "github.com/dobesv/reviewdog/service/gerrit"
	githubservice "github.com/dobesv/reviewdog/service/github"
	"github.com/dobesv/reviewdog/service/github/githubutils"
	gitlabservice "github.com/dobesv/reviewdog/service/gitlab"
)
...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "See https://github.com/dobesv/reviewdog for more detail.")
	os.Exit(2)
}
...
func runList(w io.Writer) error {
	...
	fmt.Fprintf(tabw, "%s\t%s\t- %s\n", "rdjson", "Reviewdog Diagnostic JSON Format (JSON of DiagnosticResult message)", "https://github.com/dobesv/reviewdog")
	fmt.Fprintf(tabw, "%s\t%s\t- %s\n", "rdjsonl", "Reviewdog Diagnostic JSONL Format (JSONL of Diagnostic message)", "https://github.com/dobesv/reviewdog")
